...
import { $ as assert, A as RECOGNIZERS, B as lerp, C as pixelsToWorld, D as COORDINATE_SYSTEM, E as memoize, F as Matrix4, G as lerp$1, H as sub, I as scale, J as register, K as ShaderAssembler, L as transformMat4, M as EventManager, N as geometry_default, O as EVENT_HANDLERS, Q as isBrowser, R as Vector3, T as project_default, U as clamp, V as sqrLen, W as equals, X as load, Y as defaultLogger, Z as registerLoaders, _ as getFlyToDuration, a as Transition, b as altitudeToFovy, c as LIFECYCLE, f as WebMercatorViewport, g as flyToViewport, i as assert$1, k as PROJECTION_MODE, m as typed_array_manager_default, o as deepEqual, p as Viewport, q as debug, s as flatten, t as Layer, v as normalizeViewportProps, x as fovyToAltitude, y as MAX_LATITUDE, z as len } from "./layer-Dk-IkLnG.js";
import { C as Stats, S as lumaStats, T as isBrowser$1, a as loadSpectorJS, i as DEFAULT_SPECTOR_PROPS, m as Device, r as loadWebGLDeveloperTools, x as log } from "./webgl-device-DS1fI8Wr.js";
...
var WebGLAdapter = class extends Adapter {
	...
	*/
	async attach(gl, props = {}) {
		const { WebGLDevice } = await import("./webgl-device-DS1fI8Wr.js").then((n) => n.n);
